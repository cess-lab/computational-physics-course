...
%[text] **Working arrangement.** Complete the Week 02 individual practical quiz in Google Classroom before discussing the problem or using MATLAB, notes, calculators, or AI. Then work in a group of two or three. MATLAB Copilot may be used during group work, but every material suggestion must be declared and independently tested.
%%
%[text] ## Complete the Individual Check First
%[text] Each student submits the [Week 02 Individual Practical Check — Quiz](https://classroom.google.com/c/ODcyNDE5ODM4MTIx/a/ODcyNDE5OTc1Mzg5/details) before group work begins. Do not duplicate those answers here.
%%

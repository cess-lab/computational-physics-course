...
% Clockwise mesh arrows are shown in the lower half; junction arrows make
% the branch-current convention explicit at the top shared junction.
...
\draw[->,weekblue] (2.10,3)--(2.72,3) node[midway,above=2pt] {$I_1$};
\draw[->,weeksage!70!black] (3.28,3)--(3.90,3) node[midway,above=2pt] {$I_2$};
\draw[->,weekochre!90!black] (3.42,2.62)--(3.42,2.12) node[midway,right=3pt] {$I_{\mathrm{shared}}$};
\end{tikzpicture}
\end{document}

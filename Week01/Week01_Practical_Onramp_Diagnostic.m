...
%[text] **Working arrangement.** Complete the individual Google Form before discussing the problem or using MATLAB, notes, calculators, or AI. Then work in a group of two or three. MATLAB Copilot may be used during the group activity, but every suggestion must be understood, declared, and independently checked.
%%
%[text] ## Complete the Individual Check First
%[text] Each student submits the Week 01 section of the [PHY4605 Individual Practical Check](https://docs.google.com/forms/d/e/1FAIpQLSc1q0t0yBi8XVwrrNH2G2H8Sc66VFy2fBMkbhJaTZ3TGRxkvw/viewform) before group work begins. The check is diagnostic and is not marked individually. Do not duplicate those answers in this Live Script.
%%
%[text] ## Group Record

...
Independent formulation and blank-page MATLAB implementation are distinction-level capabilities rather than ordinary pass requirements.
...
- **Core/pass level:** familiar-model formulation; variables and units; guided pseudocode; reading, tracing, completing, and modifying commented code; one appropriate validation check; and physical interpretation.
...
Written assessments must not reward memorisation of MATLAB function names, blank-page programming, or advanced derivations for ordinary pass marks. Provide necessary formulas, syntax/method references, and scaffolds. Use familiar physics with a changed parameter, supplied graph, short code defect, or interpretation question. Fully unseen formulation and independent code writing are distinction evidence.

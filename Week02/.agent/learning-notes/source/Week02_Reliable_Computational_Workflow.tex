...
\begin{keybox}
\textbf{Preparation for the practical.} Complete the Week 02 individual Google Form first. Then bring the projectile model from physical assumptions to pseudocode, repair the supplied candidate, and defend the validation evidence. MATLAB Copilot is allowed only during group work and every material suggestion must be declared and tested.
\end{keybox}
